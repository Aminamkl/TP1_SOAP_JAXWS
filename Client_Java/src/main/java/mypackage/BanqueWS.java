 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws.example.org/", wsdlLocation = "http://localhost:8585/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://ws.example.org/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ws.example.org/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.example.org/", "BanqueServicePort"), BanqueService.class, features);
    }
